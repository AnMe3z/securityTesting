...
//as far as I understand there is no sure way to prevent DoS attacks
//the only thing you can do is to implement safety net features 
//in this case its withdraw function
