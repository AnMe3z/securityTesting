...
//to solve this vulnerability you need to initialize a new contract inside the constructor
//and make the address of external contract public so that the code of the external contract can be reviewed
contract Foo {
    //make public
    Bar public bar;
